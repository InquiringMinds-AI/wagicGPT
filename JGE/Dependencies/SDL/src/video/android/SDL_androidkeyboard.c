...
static SDL_Scancode Android_Keycodes[] = {
    ...
    SDL_SCANCODE_K, /* AKEYCODE_BUTTON_Y -> JGE_BTN_SEC */
    SDL_SCANCODE_UNKNOWN, /* AKEYCODE_BUTTON_Z */
    SDL_SCANCODE_Q, /* AKEYCODE_BUTTON_L1 -> JGE_BTN_PREV */
    SDL_SCANCODE_E, /* AKEYCODE_BUTTON_R1 -> JGE_BTN_NEXT */
    ...
    SDL_SCANCODE_RETURN, /* AKEYCODE_BUTTON_START -> JGE_BTN_MENU */
    SDL_SCANCODE_LCTRL, /* AKEYCODE_BUTTON_SELECT -> JGE_BTN_CTRL */

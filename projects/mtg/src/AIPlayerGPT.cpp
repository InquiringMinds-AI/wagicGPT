...
void AIPlayerGPT::runParseSelfTest()
{
    ...
    cout << "\n[A-shockland] ETB pay-life-or-tapped menu annotation (deck137 wave-24)\n";
    {
        ...
        // The untapped default keeps the (lane-C-named) true consequence text.

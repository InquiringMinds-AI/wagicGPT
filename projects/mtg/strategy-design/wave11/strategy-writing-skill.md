# Skill: Writing a per-deck strategy guide for the qwen pilot (wave 11)

## Synthesis notes (wave 11) — the SECOND verification corpus (wave-10 engine batch validated at scale)

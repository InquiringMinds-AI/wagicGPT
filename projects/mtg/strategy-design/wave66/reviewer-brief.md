...
that under-charges (a pending Mine/punisher draw retired by a cantrip); (7) the 83 `unparsed_reply` records — which seam, which shape, and what the Baka fallback did in each game that mattered): /home/magi/.Wagic/ai/gpt/selfplay-runs/matchups-20260906-064038/ (21 games: 21 natural, 0 crashed, 0 hung, 127 min; 2317 decisions, 83 `unparsed_reply` -> Baka (3.6%; NEW this wave, wave 65 had 0 heuristic fallbacks — 33 replies carry NO coded line at all (the prose says "Therefore, I cast nothing" / "I will choose option 1" and the label never appears), 50 carry a label the parser still refused; treat as lane AR H2a's first live cost and characterise BOTH shapes with verbatim replies), 20 `repeat_past_stop`, 6 `named_row_reask`, 2 `reveal_stall_forced` (a wave-58/59 signature — adjudicate), 2 `wall_miss_unrecorded_wall`; `post_answer_overrun` 1390/2317 (60%, was 72%); p90 latency 94 s (was 74 s), max 900 s; 152 5/6, 146 4/6, 162/130/126 3/6, 123 2/6, 125 1/6; two lopsided finishes 125v130 67/0 and 125v126 60/5).

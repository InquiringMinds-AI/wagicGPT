# wave-51 seat-reviewer brief (common to all seats)
...
1. projects/mtg/strategy-design/wave51/review-carry.md  (new-baseline discipline + the
   prediction sets you must adjudicate — PASS / FAIL / UNTESTED; UNTESTED is a real verdict
   when no window arose; never infer).
2. projects/mtg/strategy-design/wave50/strategy-writing-skill.md (the CURRENT skill edition, amendments 1-151:
...
- projects/mtg/strategy-design/wave51/seats/seat-<ids>.md — same shape as the wave-50 seat
...
- projects/mtg/strategy-design/wave51/deck<N>/strategy.txt — the FULL revised guide per deck
...
- projects/mtg/strategy-design/wave51/deck<N>/skill.md — proposals for the strategy-writing
...
lanes A/B/C/D/E/F (+ the morph and ability-border Vita fixes) (wave51/review-carry.md lists

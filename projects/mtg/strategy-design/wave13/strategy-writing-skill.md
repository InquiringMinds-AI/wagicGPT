# Skill: Writing a per-deck strategy guide for the qwen pilot (wave 13)

## Synthesis notes (wave 13) — the FIRST clean validation of the name-echo era (wave-12/13a were Spark-crash contaminated)

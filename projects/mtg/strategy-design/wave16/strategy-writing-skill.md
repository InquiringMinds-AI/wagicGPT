# Skill: Writing a per-deck strategy guide for the qwen pilot (wave 16)

## Synthesis notes (wave 16) — the FIRST first-guided-corpus VALIDATION cycle; a second guideless newcomer (an ENGINE deck); four veteran freezes; core 11th PASS

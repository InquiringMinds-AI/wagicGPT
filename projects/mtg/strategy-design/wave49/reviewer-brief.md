# wave-49 seat-reviewer brief (common to all seats)
...
1. projects/mtg/strategy-design/wave49/review-carry.md  (new-baseline discipline + the
   prediction sets you must adjudicate — PASS / FAIL / UNTESTED; UNTESTED is a real verdict
   when no window arose; never infer).
2. projects/mtg/strategy-design/wave48/strategy-writing-skill.md (the CURRENT skill edition, amendments 1-119:
...
3. Your seats' wave-48 file(s) in projects/mtg/strategy-design/wave48/seats/ (rung state,
   open predictions), and the live guides projects/mtg/bin/Res/ai/baka/deckN_strategy.txt.

CORPUS: ~/.Wagic/ai/gpt/selfplay-runs/matchups-20260827-094106/ — one JSONL per SEAT
...
- projects/mtg/strategy-design/wave49/seats/seat-<ids>.md — same shape as the wave-48 seat
...
- projects/mtg/strategy-design/wave49/deck<N>/strategy.txt — the FULL revised guide per deck
...
- projects/mtg/strategy-design/wave49/deck<N>/skill.md — proposals for the strategy-writing
...
lanes R/S/T/U (+ the Vita human-seat fixes) (wave49/review-carry.md lists

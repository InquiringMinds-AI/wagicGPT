# Skill: Writing a per-deck strategy guide for the qwen pilot (wave 19)

## Synthesis notes (wave 19) — FIFTH per-deck-rotation cycle; one guideless newcomer (Zombies); one first-GUIDED-corpus validation that produced a revision (14 Deep Blue); two revised-guide re-validations (49 Dragons, 35 Slivers, each round 2) plus one revised round 3 (62 Enchantresses); two veteran freezes (110/135); the GPT reveal seam went live at deck135; core 14th PASS

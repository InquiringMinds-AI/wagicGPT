# Skill: Writing a per-deck strategy guide for the qwen pilot (wave 17)

## Synthesis notes (wave 17) — THIRD per-deck-rotation cycle; two guideless newcomers (Dragons, Slivers); two first-guide revisions (62 surgical, 21 race-math tighten); three veteran freezes; core 12th PASS

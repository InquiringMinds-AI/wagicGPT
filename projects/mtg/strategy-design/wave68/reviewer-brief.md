...
CORPUS (wave 68, binary = master __HASH__ = wave-67 close 949a514d7 + wave-68 step 1: __LANES__; read wave68/known-bugs.md,
...
guide is ~18K tokens smaller per prompt). Lane-flagged questions for the engine seat: __QUESTIONS__): __CORPUS_DIR__ (__CORPUS_STATS__).
...
wave68/strategy-writing-skill.md, amendments 1-332 (332 = the guide rule; read it first) — read it before proposing; a proposal that

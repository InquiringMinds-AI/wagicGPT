# Skill: Writing a per-deck strategy guide for the qwen pilot (wave 15)

## Synthesis notes (wave 15) — the FIRST guideless-newcomer cycle under per-deck rotation; three wave-14 fixes validated at scale; the FIRST live Force counter

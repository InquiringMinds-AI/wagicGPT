# wave-50 seat-reviewer brief (common to all seats)
...
1. projects/mtg/strategy-design/wave50/review-carry.md  (new-baseline discipline + the
   prediction sets you must adjudicate — PASS / FAIL / UNTESTED; UNTESTED is a real verdict
   when no window arose; never infer).
2. projects/mtg/strategy-design/wave49/strategy-writing-skill.md (the CURRENT skill edition, amendments 1-132:
...
3. Your seats' wave-49 file(s) in projects/mtg/strategy-design/wave49/seats/ (rung state,
   open predictions), and the live guides projects/mtg/bin/Res/ai/baka/deckN_strategy.txt.

CORPUS: ~/.Wagic/ai/gpt/selfplay-runs/matchups-20260827-115759/ — one JSONL per SEAT
...
- projects/mtg/strategy-design/wave50/seats/seat-<ids>.md — same shape as the wave-49 seat
...
- projects/mtg/strategy-design/wave50/deck<N>/strategy.txt — the FULL revised guide per deck
...
- projects/mtg/strategy-design/wave50/deck<N>/skill.md — proposals for the strategy-writing
...
lanes V/W/X/Y/Z (wave50/review-carry.md lists

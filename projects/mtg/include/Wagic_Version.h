...
//The fork's own release version - shown on the main menu; the upstream
//WAGIC_VERSION above still names the engine lineage this fork tracks.
#define WAGICGPT_VERSION_STRING "0.1.0-alpha"
